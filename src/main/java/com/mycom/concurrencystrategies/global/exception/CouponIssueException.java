package com.mycom.concurrencystrategies.global.exception;
...
public class CouponIssueException extends RuntimeException {
    ...
    public static CouponIssueException redisNotInitialized(
            Long couponId,
            CouponIssueRequest request) {
        return new CouponIssueException(
                couponId,
                request.userId(),
                request.requestId(),
                CouponIssueResult.REDIS_NOT_INITIALIZED,
                "Redis stock has not been initialized");
    }
